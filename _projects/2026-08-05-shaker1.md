...
![removed the insides](shaker-removed-the-insides.jpg)
...
![trying with h bridge](shaker-trying-with-h-bridge.jpg)
![soldered the h bridge](shaker-soldered-the-h-bridge-anyway.jpg)

Didn't work out, so I went with an off-the-shelf IC called MX1508.

![motor controller](shaker-got-myself-mx1508.jpg)
...
system with the fewest moving parts is the most reliable. So that was what I went
with.

Initially, I glued them on a shock absorber (feels close to a sponge).

![bad way to mount halls](shaker-bad-way-to-mount-hall-effect-sensors.jpg)
...
![good way to mount halls](shaker-the-right-way-to-mount.jpg)

... and a close up

![close up hall sensor](shaker-a-bit-closer.png)
...
- [AH3503 Hall effect sensor datasheet](https://www.alldatasheet.com/datasheet-pdf/pdf/1132644/AHNJ/AH3503.html)
